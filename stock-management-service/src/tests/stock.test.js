...
describe('Stock Management API', () => {
  ...
  describe('POST /api/stock/initialize', () => {
    it('should initialize stock successfully', async () => {
      ...
      expect(response.body).toEqual({ success: true, message: 'Stock initialized with 1000 items' });
  ...
  describe('POST /api/stock/reserve', () => {
    it('should reserve stock successfully', async () => {
      ...
      // Check response status and body
      expect(response.statusCode).toBe(200);
      expect(response.body).toEqual({ success: true, message: '2 items reserved', remainingStock: 998 });
    ...
    it('should return 400 for insufficient stock', async () => {
      ...
      // Check response status and body
      expect(response.statusCode).toBe(400);
      expect(response.body).toEqual({ success: false, message: 'Insufficient stock' });
